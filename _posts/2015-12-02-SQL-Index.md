...
![]({{ site.url }}/public/blog-img/sql.png)
...
```sql
select d.id from r_ibeacon_biz_page_d d where d.ftime >= 20151126 and d.ftime <= 20151126  and d.biz_id = 11023  and d.page_id = 778495  limit 0,20；
```
...
```
explain select d.id from r_ibeacon_biz_page_d d where d.ftime >= 20151126 and d.ftime <= 20151126  and d.biz_id = 11023  and d.page_id = 778495  limit 0,20；
