...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ site.url }}/public/presentation/css/default.css" media="screen">
  </head>
  <body>
    <textarea id="source">
...
Made in [Remark](http://remarkjs.com)
    ...
    <script src="{{ site.url }}/public/presentation/js/remark.min.js" type="text/javascript"></script>
