...
- 大内存加锁使用更高效的自旋锁     
- 减少了[内存碎片](https://zhuanlan.zhihu.com/p/29216091)      
...
```
![skiplist]({{ site.url }}/public/blog-img/allocator/jemalloc.png)
...
![skiplist]({{ site.url }}/public/blog-img/allocator/jemalloc-simple.png)
